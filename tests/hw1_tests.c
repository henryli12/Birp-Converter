...
Test(basecode_tests_suite, birp_to_birp_test_M, .timeout=5) {
    char *cmd = "bin/birp < rsrc/M.birp > test_output/M.birp";
    char *cmp = "cmp test_output/M.birp rsrc/M.birp";
...
Test(basecode_tests_suite, birp_to_birp_test_checker, .timeout=5) {
    char *cmd = "bin/birp < rsrc/checker.birp > test_output/checker.birp";
    char *cmp = "cmp test_output/checker.birp rsrc/checker.birp";
...
Test(basecode_tests_suite, birp_to_birp_test_stone, .timeout=5) {
    char *cmd = "bin/birp < rsrc/stone.birp > test_output/stone.birp";
    char *cmp = "cmp test_output/stone.birp rsrc/stone.birp";
...
Test(basecode_tests_suite, birp_to_birp_test_cour25, .timeout=5) {
    char *cmd = "bin/birp < rsrc/cour25.birp > test_output/cour25.birp";
    char *cmp = "cmp test_output/cour25.birp rsrc/cour25.birp";
...
Test(basecode_tests_suite, birp_to_pgm_to_ascii_test, .timeout=5) {
    char *cmd = "bin/birp -o pgm < rsrc/cour25.birp | bin/birp -i pgm -o ascii > test_output/cour25.asc";
    char *cmp = "cmp test_output/cour25.asc rsrc/cour25.asc";
...
Test(basecode_tests_suite, pmg_to_birp_test, .timeout=5) {
    char *cmd = "bin/birp -i pgm < rsrc/M.pgm > test_output/M.birp";
    char *cmp = "cmp test_output/M.birp rsrc/M.birp";
...
Test(basecode_tests_suite, pmg_to_ascii_test, .timeout=5) {
    char *cmd = "bin/birp -i pgm -o ascii < rsrc/stone.pgm > test_output/stone.asc";
    char *cmp = "cmp test_output/stone.asc rsrc/stone.asc";
...
Test(basecode_tests_suite, pmg_to_birp_to_ascii_test, .timeout=5) {
    char *cmd = "bin/birp -i pgm < rsrc/checker.pgm | bin/birp -o ascii > test_output/checker.asc";
    char *cmp = "cmp test_output/checker.asc rsrc/checker.asc";
